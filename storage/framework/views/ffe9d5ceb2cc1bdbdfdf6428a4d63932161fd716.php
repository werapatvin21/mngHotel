...
<head>
    ...
    <title><?php echo e($hotels->name); ?></title>

    <meta name="description" content="Form action bar examples">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">

    <link href="<?php echo e(url('theme/base/vendors.bundle.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(url('theme/base/style.bundle.css')); ?>" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?php echo e(url('theme/theme.css')); ?>" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Prompt" rel="stylesheet">
    <link href="<?php echo e(url('css/fontawesome.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('lib/select2/css/select2.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('lib/select2/css/select2-bootstrap4.min.css')); ?>" rel="stylesheet" type="text/css"/>
                    ...
                    <div class="row" style="height: 100%;" id="topbar">
                        ...
                        <div class="col-auto">
                            ...
                            <div id="title_box_right" class="btn-sm dropdown btn-group">
                              &nbsp;
                                <a class="dropdown-item card" href="<?php echo e(route('logout')); ?>"
...
<?php echo $__env->make('layouts.result_alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
<script src="<?php echo e(asset('js/app.js')); ?>"></script>
<script src="<?php echo e(asset('theme/base/vendors.bundle.js')); ?>"></script>
<script src="<?php echo e(asset('theme/base/scripts.bundle.js')); ?>"></script>
<script src="<?php echo e(asset('js/TRLink.js')); ?>"></script>
...
<script src="<?php echo e(asset('lib/select2/js/select2.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('lib/select2/js/i18n/th.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH C:\Users\aommy\hotel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>