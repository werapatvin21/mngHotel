<?php $__env->startSection('content'); ?>
    ...
    <div class="m-portlet m-portlet--full-height m-portlet--tabs" id="filter_bar">
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-3"></div>
            <div class="col-2">
                <a  class="btn btn--custom" href="<?php echo e(url('guest/create')); ?>"
...
<?php $__env->startPush('scripts'); ?>
                ...
                <script>
                    var t_g_booking = $('#guest-booking-table').DataTable({
                        ...
                        bDeferRender: true,
                        ajax: {
                            url: '<?php echo route('guest.booking'); ?>',
                            type: 'GET',
                            data: function (d) {
                    ...
                    var t = $('#staff-table').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'file', render:function (staff_file, _, row) {
                                    if (staff_file) {
                                        return `<a href="<?php echo e(url('')); ?>/${row.file}" target="_blank">Download file</a>`;
                                    } else {
                                        return `No file`;
                                    }
                                },width: '10%'},
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aommy\hotel\resources\views/guests/list.blade.php ENDPATH**/ ?>