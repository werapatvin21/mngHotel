    ...
    <div class="m-portlet m-portlet--full-height m-portlet--tabs" id="filter_bar">
        <div class="row" style="margin-top: 20px;">
            <div class="col justify-content-end">
                <?php if($permission->staff_role === 'admin'): ?>
                    <a  class="btn btn--custom" href="<?php echo e(url('room/create')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aommy\hotel\resources\views/room/list.blade.php ENDPATH**/ ?>