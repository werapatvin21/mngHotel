...
@section('content')
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col  d-flex flex-row-reverse">
                <div class="btn-group" role="group" aria-label="Basic example" style="">
                    ...
                    <div class="col-3">
                        <a  class="btn btn--custom" href="{{route('room.index')}}"
                ...
                <div class="modal-body">
                    ...
                    @foreach($room_types as $room_type)
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="{{url('/room_types/'.$room_type->id.'/destroy')}}">
    ...
    <form class="m-form m-form--fit " enctype="multipart/form-data"
          action="{{ $special_price->id ? route('special_price.update', ['id' => $special_price->id]) : route('special_price.store') }}"
          method="POST">
    @csrf
    @if($special_price && $special_price->id)
        <input type="hidden" name="room_id" value="{{$data->id}}">
        @method('PUT')
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->monday != 0) checked @endif name="monday">Monday
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->tuesday != 0)  checked @endif name="tuesday" >Tuesday
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->wednesday != 0)  checked @endif  name="wednesday"
                                    >Wednesday
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->thursday != 0)  checked @endif  name="thursday"
                                    >Thursday
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->friday != 0) checked @endif name="friday"
                                    >Friday
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->saturday != 0)  checked @endif  name="saturday"
                                    >Saturday
                                </label>
                            </div>
                            <div class="form-check-inline disabled">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"
                                           @if($special_price->sunday != 0)  checked @endif  name="sunday"
                                    >Sunday
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" id="datepicker_HignSeasonStart"
                                                   value="{{$special_price->season_start}}"
                                                   name="season_start"
                                                   required
                                                   width="235" /></div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" id="datepicker_HignSeasonEnd" width="235"
                                                   name="season_end"
                                                   required
                                                   value="{{$special_price->season_end}}"
                                            /></div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="m-portlet m-portlet--full-height m-portlet--tabs">
        ...
        <form class="m-form m-form--fit " enctype="multipart/form-data"
              action="{{ $data->id ? route('room.update', ['id' => $data->id]) : route('room.store') }}"
              method="POST">
            @csrf
            @if($data && $data->id)
                @method('PUT')
                    ...
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control"
                                           ...
                                           readonly="{{$detail}}"
                                           @endif
                                           value="{{$data->name}}" id="room_name" name="name" required>
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    @php $room_type_old = old('room_type',$data->room_type); @endphp
                                    <select class="form-control" id="roomType"
                                        ...
                                        @foreach($room_types as $room_type)
                                            <option {{$room_type->id === $room_type_old ?'selected':''}} value="{{$room_type->id}}"> {{$room_type->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8 my-1">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                               ...
                                               readonly="{{$detail}}"
                                               @endif
                                               value="{{$data->room_special_price}}" id="room_specialPrice" name="room_specialPrice">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">฿</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-8 my-1">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                               ...
                                               readonly="{{$detail}}"
                                               @endif
                                               value="{{$data->room_season_price}}" id="room_seasonPrice" name="room_seasonPrice">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">฿</div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="room_status" name="room_status"
                                        ...
                                        <option value="{{'maintenance'}}" @if($data->status === 'maintenance') selected @endif>Maintenance</option>
    ...
    @push('scripts')
        ...
        <script>
            @php $RoomType = session()->pull('RoomType') @endphp
            let RoomType =  '{{$RoomType?:0}}'
